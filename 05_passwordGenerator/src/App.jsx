...
function App() {
  ...
  const copyPasswordToClipboard = useCallback(() => {
    passwordRef.current?.select(); //select all text
    passwordRef.current?.setSelectionRange(0, 100); // select specified range of characters 
      ...
      <div className="w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3 my-8 text-orange-500 bg-gray-800">
        ...
        <div className="flex shadow rounded-lg overflow-hidden mb-4">
          <input
            ...
            id="password"
            value={password}
            className="outline-none bg-white text-stone-600 w-full py-1 px-3"
